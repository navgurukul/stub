...
function SidebarTrigger({
  ...
  return (
    <button
      ...
      className={cn(
        "h-7 w-7 flex items-center justify-center bg-transparent hover:bg-secondary-background text-foreground transition-colors cursor-pointer rounded-[4px]",
        className
      )}
      onClick={(event) => {
        onClick?.(event);
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden outline-2 outline-transparent rounded-[4px] p-2 text-left text-sm text-foreground ring-ring transition-[width,height,padding] hover:bg-secondary-background hover:text-foreground focus-visible:outline-border focus-visible:text-foreground focus-visible:bg-secondary-background disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 data-[active=true]:bg-secondary-background data-[active=true]:text-foreground cursor-pointer",
  {
    variants: {
      size: {
        default: "h-8 text-sm",
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "[&_svg]:text-muted-foreground hover:[&_svg]:text-foreground text-foreground hover:bg-secondary-background outline-transparent outline-2 absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-[4px] p-0 transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 cursor-pointer",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 md:after:hidden",
